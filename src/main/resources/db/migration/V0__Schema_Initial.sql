...
create unique index candlestick_data_id_uindex
    on candlestick_data (id);

create index candlestick_data_close_price_index
    on candlestick_data (close_price);

create index candlestick_data_high_price_index
    on candlestick_data (high_price);

create index candlestick_data_low_price_index
